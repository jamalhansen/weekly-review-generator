...
class TestSummarizeCLI:
    @patch("weekly_review.logic.find_vault_root")
    @patch("weekly_review.logic.resolve_provider")
    @patch("weekly_review.logic.write_review_section")
    def test_summarize_json_output(self, mock_write, mock_resolve, mock_find_vault):
        ...
        with patch("weekly_review.logic.load_daily_notes_for_week") as mock_load:
